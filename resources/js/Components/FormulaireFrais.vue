...
// Initialisation des variables pour le formulaire hors forfait
const libelle = ref(""); // Initialise libelle avec une chaîne vide
const price = ref(""); // Initialise price à 0
